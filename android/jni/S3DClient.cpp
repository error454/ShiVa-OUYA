...
// @@END_JNI_INCLUDES@@
//----------------------------------------------------------------------        
#define LOGI(...) __android_log_print(ANDROID_LOG_INFO, "yourgame", __VA_ARGS__)
//----------------------------------------------------------------------        
extern "C"
{ 
    //----------------------------------------------------------------------
    ...
    static int ClientFunctionCallback_onRequestOuyaGamerID ( int _iInCount, const S3DX::AIVariable *_pIn, S3DX::AIVariable *_pOut )
    {
        JNIEnv *pJNIEnv = GetJNIEnv();
        if (pJNIEnv)
        {
            jclass pJNIActivityClass = pJNIEnv->FindClass("com/yourgame/ouya/yourgame");
            jmethodID pJNIMethodID = pJNIEnv->GetStaticMethodID(pJNIActivityClass, "requestOuyaGamerID", "()V");
            pJNIEnv->CallStaticVoidMethod(pJNIActivityClass, pJNIMethodID, NULL);
        }
        return 0 ;
    }

    static int ClientFunctionCallback_onRequestOuyaProductList ( int _iInCount, const S3DX::AIVariable *_pIn, S3DX::AIVariable *_pOut )
    {
        JNIEnv *pJNIEnv = GetJNIEnv();
        if (pJNIEnv)
        {
            jclass pJNIActivityClass = pJNIEnv->FindClass("com/yourgame/ouya/yourgame");
            jmethodID pJNIMethodID = pJNIEnv->GetStaticMethodID(pJNIActivityClass, "requestOuyaProductList", "()V");
            pJNIEnv->CallStaticVoidMethod(pJNIActivityClass, pJNIMethodID, NULL);
        }
        return 0 ;
    }

    static int ClientFunctionCallback_onRequestOuyaPurchase ( int _iInCount, const S3DX::AIVariable *_pIn, S3DX::AIVariable *_pOut )
    {
        JNIEnv *pJNIEnv = GetJNIEnv();
        if (pJNIEnv)
        {
            if ( ( _iInCount == 1 ) && _pIn[0].IsNumber ( ) )
            {
                jclass pJNIActivityClass = pJNIEnv->FindClass("com/yourgame/ouya/yourgame");
    ...
    static int ClientFunctionCallback_onRequestOuyaReceipts ( int _iInCount, const S3DX::AIVariable *_pIn, S3DX::AIVariable *_pOut )
    {
        JNIEnv *pJNIEnv = GetJNIEnv();
        if (pJNIEnv)
        {
            jclass pJNIActivityClass = pJNIEnv->FindClass("com/yourgame/ouya/yourgame");
            jmethodID pJNIMethodID = pJNIEnv->GetStaticMethodID(pJNIActivityClass, "requestOuyaReceipts", "()V");
            pJNIEnv->CallStaticVoidMethod(pJNIActivityClass, pJNIMethodID, NULL);
        }
        return 0 ;
    }

    static int ClientFunctionCallback_onEngineInitialized ( int _iInCount, const S3DX::AIVariable *_pIn, S3DX::AIVariable *_pOut )
	{
		JNIEnv *pJNIEnv = GetJNIEnv();
		if (pJNIEnv)
		{
			jclass pJNIActivityClass = pJNIEnv->FindClass("com/yourgame/ouya/yourgame");
			jmethodID pJNIMethodID = pJNIEnv->GetStaticMethodID(pJNIActivityClass, "engineInitialized", "()V");
			pJNIEnv->CallStaticVoidMethod(pJNIActivityClass, pJNIMethodID, NULL);
		}
		return 0;
	}
    ...
    static const int        iClientFunctionsCount = 6 ; // Modify this number when adding new functions just below
    static S3DX::AIFunction aClientFunctions  [ ] =
    {
        { "onEngineEvent", ClientFunctionCallback_onEngineEvent, "...", "...", "...", 0 },
        { "onRequestOuyaGamerID", ClientFunctionCallback_onRequestOuyaGamerID, "...", "...", "...", 0 },
        { "onRequestOuyaProductList", ClientFunctionCallback_onRequestOuyaProductList, "...", "...", "...", 0 },
        { "onRequestOuyaPurchase", ClientFunctionCallback_onRequestOuyaPurchase, "...", "...", "...", 0 },
        { "onRequestOuyaReceipts", ClientFunctionCallback_onRequestOuyaReceipts, "...", "...", "...", 0 },
        { "onEngineInitialized", ClientFunctionCallback_onEngineInitialized, "...", "...", "...", 0 }
    } ;
                ...
                jfloat ls_x, jfloat ls_y, jfloat rs_x, jfloat rs_y, jfloat l2, jfloat r2)
    {
        ...
        args[1].SetNumberValue( ls_x );
        args[2].SetNumberValue( ls_y );
        args[3].SetNumberValue( rs_x );
    ...
    * I can't create constants to guide the user.  I decided against it as this pattern is a better mirror for the existing
    * ShiVa key handler style.
    */
    JNIEXPORT void JNICALL Java_com_yourgame_ouya_S3DRenderer_ouyaKeyEvent ( JNIEnv *_pEnv, jobject obj, jint playerNum, jint key, jboolean value)
    {
        S3DX::AIVariable args[3];
        args[0].SetNumberValue( playerNum );
        args[1].SetNumberValue( key );
        args[2].SetBooleanValue( value );
    ...
    JNIEXPORT void JNICALL Java_com_yourgame_ouya_yourgame_receiveOuyaPurchase ( JNIEnv *_pEnv, jobject obj, jboolean success)
	{
		...
		S3DClient_SendEventToCurrentUser( "OuyaPurchase", "onReceiveOuyaPurchase", 1, (const void*)args);
	}

    JNIEXPORT void JNICALL Java_com_yourgame_ouya_yourgame_receiveOuyaReceipt ( JNIEnv *_pEnv, jobject obj, jstring id, jlong date, jint price)
	{
    	S3DX::AIVariable args[3];
    	args[0].SetStringValue("");
    ...
    //----------------------------------------------------------------------        
    JNIEXPORT void JNICALL Java_com_yourgame_ouya_S3DRenderer_engineSetPackFileDescriptor ( JNIEnv *_pEnv, jobject obj, jobject fileDescriptor, jlong offset, jlong length )
    {
    ...
    //----------------------------------------------------------------------        
    JNIEXPORT void JNICALL Java_com_yourgame_ouya_S3DRenderer_engineSetLocationSupport ( JNIEnv *_pEnv, jobject obj, jboolean bSupport )
    {
        bSupportLocation = bSupport ;
    }        
    //----------------------------------------------------------------------        
    JNIEXPORT void JNICALL Java_com_yourgame_ouya_S3DRenderer_engineSetHeadingSupport ( JNIEnv *_pEnv, jobject obj, jboolean bSupport )
    {
        bSupportHeading = bSupport ;
    }        
    //----------------------------------------------------------------------        
    JNIEXPORT void JNICALL Java_com_yourgame_ouya_S3DRenderer_engineSetDeviceName ( JNIEnv *_pEnv, jobject obj, jstring sName )
    {
    ...
    //----------------------------------------------------------------------        
    JNIEXPORT void JNICALL Java_com_yourgame_ouya_S3DRenderer_engineSetDeviceModel ( JNIEnv *_pEnv, jobject obj, jstring sModel )
    {
    ...
    //----------------------------------------------------------------------        
    JNIEXPORT void JNICALL Java_com_yourgame_ouya_S3DRenderer_engineSetDeviceIPAddress ( JNIEnv *_pEnv, jobject obj, jstring sAddress )
    {
    ...
    //----------------------------------------------------------------------        
    JNIEXPORT void JNICALL Java_com_yourgame_ouya_S3DRenderer_engineSetDeviceUUID ( JNIEnv *_pEnv, jobject obj, jstring sUUID )
    {
    ...
    //----------------------------------------------------------------------        
    JNIEXPORT void JNICALL Java_com_yourgame_ouya_S3DRenderer_engineSetSystemVersion ( JNIEnv *_pEnv, jobject obj, jstring sVersion )
    {
    ...
    //----------------------------------------------------------------------        
    JNIEXPORT void JNICALL Java_com_yourgame_ouya_S3DRenderer_engineSetSystemLanguage ( JNIEnv *_pEnv, jobject obj, jstring sLanguage )
    {
    ...
    //----------------------------------------------------------------------        
    JNIEXPORT void JNICALL Java_com_yourgame_ouya_S3DRenderer_engineSetCameraDeviceCount ( JNIEnv *_pEnv, jobject obj, jint count )
    {
        //iCameraDeviceCount = count ;
    }
    //----------------------------------------------------------------------        
    JNIEXPORT void JNICALL Java_com_yourgame_ouya_S3DRenderer_engineSetCameraDeviceName ( JNIEnv *_pEnv, jobject obj, jint index, jstring sName )
    {
        //const char *pNameStr = _pEnv->GetStringUTFChars ( sName, NULL ) ;
    ...
    //----------------------------------------------------------------------        
    JNIEXPORT void JNICALL Java_com_yourgame_ouya_S3DRenderer_engineOnCameraDeviceFrame ( JNIEnv *_pEnv, jobject obj, jbyteArray data, jint w, jint h )
    {
        /*???
    ...
    //----------------------------------------------------------------------        
    JNIEXPORT void JNICALL Java_com_yourgame_ouya_S3DRenderer_engineForceDefaultOrientation ( JNIEnv *_pEnv, jobject obj, jboolean b )
    {
        bForceNoViewportRotation = b ; // TODO: set an engine's option instead
    }    
    //----------------------------------------------------------------------        
    JNIEXPORT jboolean JNICALL Java_com_yourgame_ouya_S3DRenderer_engineInitialize ( JNIEnv *_pEnv, jobject obj )
    {
    ...
    //----------------------------------------------------------------------        
    JNIEXPORT void JNICALL Java_com_yourgame_ouya_S3DRenderer_engineShutdown ( JNIEnv *_pEnv, jobject obj ) 
    { 
        LOGI( "### engineShutdown" ) ; 
        S3DClient_Shutdown ( ) ;
        pJavaVM = NULL ;
    ...
    //----------------------------------------------------------------------        
    JNIEXPORT jboolean JNICALL Java_com_yourgame_ouya_S3DRenderer_engineRunOneFrame ( JNIEnv *_pEnv, jobject obj )
    {
        //LOGI( "### runOneFrame" ) ; 
    ...
    //----------------------------------------------------------------------        
    JNIEXPORT void JNICALL Java_com_yourgame_ouya_S3DRenderer_enginePause ( JNIEnv *_pEnv, jobject obj, jboolean b ) 
    { 
    ...
    //----------------------------------------------------------------------        
    JNIEXPORT void JNICALL Java_com_yourgame_ouya_S3DRenderer_engineOnSurfaceCreated ( JNIEnv *_pEnv, jobject obj )        
    {
    ...
    //----------------------------------------------------------------------        
    JNIEXPORT void JNICALL Java_com_yourgame_ouya_S3DRenderer_engineOnSurfaceChanged ( JNIEnv *_pEnv, jobject obj, jint w, jint h )        
    {
    ...
    //----------------------------------------------------------------------        
    JNIEXPORT void JNICALL Java_com_yourgame_ouya_S3DRenderer_engineOnMouseMove ( JNIEnv *_pEnv, jobject obj, jfloat x, jfloat y )        
    {
    ...
    //----------------------------------------------------------------------        
    JNIEXPORT void JNICALL Java_com_yourgame_ouya_S3DRenderer_engineOnMouseButtonDown ( JNIEnv *_pEnv, jobject obj, jfloat x, jfloat y )        
    {
        bMouseButtonDown = true ;
        S3DClient_iPhone_OnMouseMoved           ( 2.0f * x / (float)iSurfaceWidth - 1.0f, 2.0f * ( (float)iSurfaceHeight - y ) / (float)iSurfaceHeight - 1.0f ) ;        
        S3DClient_iPhone_OnMouseButtonPressed   ( ) ;        
    ...
    //----------------------------------------------------------------------        
    JNIEXPORT void JNICALL Java_com_yourgame_ouya_S3DRenderer_engineOnMouseButtonUp ( JNIEnv *_pEnv, jobject obj, jfloat x, jfloat y )        
    {
    ...
    //----------------------------------------------------------------------        
    JNIEXPORT void JNICALL Java_com_yourgame_ouya_S3DRenderer_engineOnTouchesChange ( JNIEnv *_pEnv, jobject obj, jint tc1, jfloat x1, jfloat y1, jint tc2, jfloat x2, jfloat y2, jint tc3, jfloat x3, jfloat y3, jint tc4, jfloat x4, jfloat y4, jint tc5, jfloat x5, jfloat y5 )
    {
    ...
    //----------------------------------------------------------------------        
    JNIEXPORT void JNICALL Java_com_yourgame_ouya_S3DRenderer_engineOnDeviceMove ( JNIEnv *_pEnv, jobject obj, jfloat x, jfloat y, jfloat z )
    {
    ...
    //----------------------------------------------------------------------        
    JNIEXPORT void JNICALL Java_com_yourgame_ouya_S3DRenderer_engineOnKeyboardKeyDown ( JNIEnv *_pEnv, jobject obj, jint key, jint uni )        
    {
        S3DClient_Android_OnKeyboardKeyPressed ( key, uni ) ;
    }
    //----------------------------------------------------------------------        
    JNIEXPORT void JNICALL Java_com_yourgame_ouya_S3DRenderer_engineOnKeyboardKeyUp ( JNIEnv *_pEnv, jobject obj, jint key, jint uni )        
    {
        S3DClient_Android_OnKeyboardKeyReleased ( key, uni ) ;
    }
    //----------------------------------------------------------------------        
    JNIEXPORT void JNICALL Java_com_yourgame_ouya_S3DRenderer_engineOnLocationChanged ( JNIEnv *_pEnv, jobject obj, jfloat x, jfloat y, jfloat z )
    {
        S3DClient_Android_UpdateLocation ( x, y, z ) ;
    }
    //----------------------------------------------------------------------        
    JNIEXPORT void JNICALL Java_com_yourgame_ouya_S3DRenderer_engineOnHeadingChanged ( JNIEnv *_pEnv, jobject obj, jfloat angle )
    {
        S3DClient_Android_UpdateHeading ( angle, angle ) ;
    }
    //----------------------------------------------------------------------   
    JNIEXPORT void JNICALL Java_com_yourgame_ouya_S3DRenderer_engineOnOverlayMovieStopped ( JNIEnv *_pEnv, jobject obj )
    {
        aOverlayMovie[0] = '\0' ;
        S3DClient_OnOverlayMovieStopped ( ) ;
    }
    //----------------------------------------------------------------------   
    JNIEXPORT jstring JNICALL Java_com_yourgame_ouya_S3DRenderer_engineGetOverlayMovie ( JNIEnv *_pEnv, jobject obj )
    {
        return _pEnv->NewStringUTF ( aOverlayMovie ) ;
    }
    //----------------------------------------------------------------------   
    jboolean JNICALL Java_com_yourgame_ouya_S3DRenderer_engineGetCameraDeviceState ( JNIEnv *_pEnv, jobject obj )
    {
        return bWantCameraDeviceCapture ;
    }
    //----------------------------------------------------------------------   
    //jboolean Java_com_yourgame_ouya_S3DRenderer_engineGetVibratorState ( JNIEnv *_pEnv, jobject obj )
    //{
    //  return bVibrate ;
    //}
    //----------------------------------------------------------------------   
    JNIEXPORT jboolean JNICALL Java_com_yourgame_ouya_S3DRenderer_engineGetWantSwapBuffers ( JNIEnv *_pEnv, jobject obj )
    {
